    ...
    <div class="container mx-auto relative">
        ...
        <div class="relative">
            ...
            <div id="carousel" class="flex space-x-4 overflow-x-hidden scrollbar-hide snap-x snap-mandatory">
                <!-- Article -->
                <div class="min-w-[25%] bg-white rounded-lg shadow-lg overflow-hidden border snap-start">
                    <img src="https://foshanwindowsdoors.com/wp-content/themes/rogenilan/uploads/240831/1-240S11K000137.jpg" alt="Customize Your Entry Door" class="w-full h-48 object-cover">
                    <div class="p-4">
            ...
            <!-- Carousel Controls -->
            <button id="prevButton" class="absolute top-1/2 -translate-y-1/2 -left-16 bg-white border rounded-full p-3 shadow-md hover:bg-gray-200 transition duration-300 focus:outline-none">
                <i class="fas fa-chevron-left"></i>
            </button>
            <button id="nextButton" class="absolute top-1/2 -translate-y-1/2 -right-16 bg-white border rounded-full p-3 shadow-md hover:bg-gray-200 transition duration-300 focus:outline-none">
