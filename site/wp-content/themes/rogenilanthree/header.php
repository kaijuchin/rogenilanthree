	...
	<nav class="bg-white shadow">
		<div class="container mx-auto px-4">
			<div class="flex justify-between items-center py-4">
				...
				<!-- Navbar links -->
				<div id="navbar-links" class="hidden md:flex items-center md:ml-32">
                    ...
                    <div id="m-windows" class="md:hidden relative group text-center w-full">
                        <a id="m-windows-toggle" href="#" class="block mx-8 my-4 text-gray-700 hover:text-red-500">Windows <span class="sub-arrow"><i class="fas fa-chevron-down"></i></span></a>
                        <div id="m-windows-dropdown" class="hidden w-full bg-gray-700/[.05]">
                            <?php foreach (WINDOWS_SYSTEMS as $item):  ?>
                            <a href="#" class="<?= do_shortcode('[nav_dropdown_items_class name=item]'); ?>"><?= $item['name']; ?></a>
                            <?php  endforeach; ?>
                        </div>
                    </div>
                    ...
                    <div id="m-about" class="md:hidden relative group text-center w-full">
                        <a id="m-about-toggle" href="#" class="block mx-8 my-4 text-gray-700 hover:text-red-500">About</a>
